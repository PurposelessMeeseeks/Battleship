...
{
    [TestClass]
    public class TestLinearShootingEliminator
    {
        [TestMethod]
        ...
        [TestMethod]
        public void NextTargetReturnsOneOfSquaresAboveOrBelowSquares3_3And3_4()
        {
            Grid grid = new Grid(10, 10);
        ...
        [TestMethod]
        public void NextTargetReturnsOneOfSquaresAboveOrBelowSquares3_3And3_9()
        {
            Grid grid = new Grid(10, 10);
        ...
        [TestMethod]
        public void NextTargetReturnsOneOfSquaresAboveOrBelowSquares3_0And3_1()
        {
            Grid grid = new Grid(10, 10);

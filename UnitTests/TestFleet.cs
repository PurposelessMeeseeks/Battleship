...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    public class TestFleet
    {
        ...
        [TestMethod]
        public void HitForFleetReturnsSunkenIfAllSquaresThatBelongingToAShipAreHit()
        {
            Fleet fleet = new Fleet();
            List<Square> squares = new List<Square> { new Square(1, 2), new Square(1, 3), new Square(1, 4) };
            fleet.CreateShip(squares);
            ...
            HitResult result = fleet.Hit(new Square(1, 4));
            Assert.AreEqual(HitResult.Sunken, result);
        }

        [TestMethod]
        public void HitForFleetReturnsSunkenIfAllSquaresThatBelongingToOneOfShipsAreHit()
        {
            Fleet fleet = new Fleet();
            List<Square> squares = new List<Square> { new Square(1, 2), new Square(1, 3), new Square(1, 4) };
            fleet.CreateShip(squares);

...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    public class TestFleet
    {
        ...
        [TestMethod]
        public void HitForFleetReturnsMissedIfSqaureDoesntBeLongToAnyShip()
        {
            Fleet fleet = new Fleet();
            List<Square> squares = new List<Square> { new Square(1, 2), new Square(1, 3), new Square(1, 4) };
            fleet.CreateShip(squares);
        ...
        [TestMethod]
        public void HitForFleetReturnsHitIfSqaureDoesntBeLongToAnyShip()
        {
            Fleet fleet = new Fleet();
            List<Square> squares = new List<Square> { new Square(1, 2), new Square(1, 3), new Square(1, 4) };
            fleet.CreateShip(squares);
        ...
        [TestMethod]
        public void HitForFleetReturnsSunkenIfAllSqaureDoesntBeLongToAShipAreHit()
        {
            Fleet fleet = new Fleet();
            List<Square> squares = new List<Square> { new Square(1, 2), new Square(1, 3), new Square(1, 4) };
            fleet.CreateShip(squares);

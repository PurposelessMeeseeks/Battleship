...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    public class TestGunnery
    {
        ...
        [TestMethod]
        public void ShootingTacticsChangesFromRandomToSurroudingWhenFirstSquareIsHit()
        {
            Gunnery g = new Gunnery(10, 10, new List<int> { 5, 3 });
        ...
        [TestMethod]
        public void ShootingTacticsRemainsSurroudingAfterSquareIsMissed()
        {
            Gunnery g = new Gunnery(10, 10, new List<int> { 5, 3 });
            g.RecordShootingResult(HitResult.Hit);
            Assert.AreEqual(ShootingTactics.Surrounding, g.ShootingTactics);
        ...
        [TestMethod]
        public void ShootingTacticsChangesFromSurroudingToLinearAfterSecondSquareIsHit()
        {
            Gunnery g = new Gunnery(10, 10, new List<int> { 5, 3 });
            g.RecordShootingResult(HitResult.Hit);
            g.RecordShootingResult(HitResult.Hit);
